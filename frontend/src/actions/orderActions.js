...
export const payForOrder = (order) => async (dispatch, getState) => {
  try {
    dispatch({
    ...
    const { data } = await axios.post(`/api/orders/payid`, order, {}) //pass the id into this route as well as the config and extract data
